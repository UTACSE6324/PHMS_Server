<?php
  ...
  if(!empty($res)){
    ...
    $note = $pdo -> query("select * from note where uid = '$uid' and name = '$key';") -> fetchAll();
    $noteArray = new Array();
    foreach($note as $col){
    ...
    $contact = $pdo -> query("select * from contact where uid = '$uid' and name = '$key';") -> fetchAll();
    ...
    $notice = $pdo -> query("select * from notice where uid = '$uid' and description = '$key';") -> fetchAll();
